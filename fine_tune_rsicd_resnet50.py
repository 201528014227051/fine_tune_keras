...
from data_manager_resnet50 import DataManager
os.environ["CUDA_VISIBLE_DEVICES"] = "5,6"
num_epochs = 100
batch_size = 10#100#256
voice_dim = 300#1690#
root_path = '../datasets/rsicd/'
class_txt_path = './txtclasses_rsicd/'
...
if not os.path.exists('../trained_models/rsicd_finetune_resnet50_adam/'):
	os.makedirs('../trained_models/rsicd_finetune_resnet50_adam/')
model_names = ('../trained_models/rsicd_finetune_resnet50_adam/' +
