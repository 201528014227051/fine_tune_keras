...
data_manager = DataManager(data_filename=captions_filename,
                            ...
                            cnn_extractor='vgg16',
                            image_directory='/home/user2/qubo_captions/data/UCM/imgs/',
...
def construct_model():
    ...
    predictions = Dense(21, activation='softmax', name = 'output21')(x)
...
model_names = ('../trained_models/ucm_finetune_vgg16/' +
