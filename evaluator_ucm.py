...
class Evaluator(object):
    ...
    def write_captions(self, dump_filename=None):
        if dump_filename == None:
            dump_filename = self.data_path + 'ucm_mt_05_10_direct.txt'
...
if __name__ == '__main__':
    ...
    root_path = '../datasets/ucm/'
    data_path = root_path 
    images_path = '/home/user2/qubo_captions/data/UCM/imgs/'
    model_filename = '../trained_models/ucm_finetune_vgg16/rsicd_weights.94-0.23.hdf5'
    model = load_model(model_filename)
    evaluator = Evaluator(model, data_path, images_path, class_path = './txtclasses_ucm/')
