...
class Evaluator(object):
    ...
    def write_captions(self, dump_filename=None):
        if dump_filename == None:
            dump_filename = self.data_path + 'sydney_mt_05_10_direct.txt'
...
if __name__ == '__main__':
    ...
    data_path = root_path 
    images_path = '/home/user2/qubo_captions/data/Sydney/imgs/'
    model_filename = '../trained_models/sydney_finetune_vgg16/rsicd_weights.98-10.62_sydney_ft.hdf5'
    model = load_model(model_filename)
    evaluator = Evaluator(model, data_path, images_path, class_path = './txtclasses_sydney/')
