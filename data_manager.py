...
class DataManager(object):
    ...
    def __init__(self, data_filename, max_caption_length=20, sep='*',
                 ...
                 split_data=True, extract_image_features=False, extract_voice_features=True,
                 image_directory=None, voice_directory = None, dump_path='preprocessed_data',
                 cnn_extractor='inception', voice_dim = 6500):
        ...
        self.extract_voice_features = extract_voice_features
        ...
        self.extracted_voice_features = None
    ...
    def write_voice_features_to_h5(self):
        print('Writing voice features to h5...')
        dataset_file = h5py.File('image_name_to_voice_features_word.h5')
        number_of_features = len(self.image_feature_files)
        for image_arg, image_file in enumerate(self.image_feature_files):
            file_id = dataset_file.create_group(image_file)
            image_data = file_id.create_dataset('voice_features',
                                        (self.num_voice_features,), dtype='float32')
            image_data[:] = self.extracted_voice_features[image_arg,:]
